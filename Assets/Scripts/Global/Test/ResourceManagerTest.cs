...
public class ResourceManagerTest : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // 测试Prefab同步加载
        var prefab1 = ResourceManager.Instance.SyncLoad<GameObject>("Prefabs/Test/ExamplePrefab1.prefab");
        GameObject.Instantiate(prefab1);
        // 测试Prefab异步加载
        ResourceManager.Instance.AsyncLoad<GameObject>("Prefabs/Test/ExamplePrefab2.prefab", (obj) =>
        {
